...
class SundaneseHomePageBuilder implements HomePageBuilder {
  @override
  ...
  SliverAppBar buildWikiPageAppBar(BuildContext context, String title) {
    final String pageUrl = 'https://su.m.wiktionary.org/wiki/$title';
  ...
  Widget buildDrawer(BuildContext context) {
    final List<Widget> drawerChildren = [
      ...
      DrawerCommunityToolsSection(
        languageCode: 'su',
        mainPageTitle: 'Tepas',
        recentChangesTitle: 'Husus:AnyarRobah',
        randomPageTitle: 'Husus:Acak',
        specialPagesTitle: 'Husus:KacaHusus',
        communityPortalTitle: 'Wiktionary:Sawala',
        helpTitle: 'Pitulung:Eusi',
        sandboxTitle: 'Wiktionary:Kotrétan',
      ),
  ...
  Widget buildBody(BuildContext context, Future<String> futureContent,
    ...
    void navigateToNewPage(String title) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute<void>(
          builder: (context) => WikiPage(languageCode: 'su', title: title),
        ),
      );
    }
    ...
    void navigateToCreatePage(String title) {
      final editUrl =
          'https://su.m.wiktionary.org/w/index.php?title=$title&action=edit';
            ...
            child: Column(
              children: [
                if (pageType == PageType.home) ...[
                  ...
                  WiktionarySearch(languageCode: 'su'),
                  const SizedBox(height: 28.0),
                ],
                ContentBody(
                  html: pageContent,
