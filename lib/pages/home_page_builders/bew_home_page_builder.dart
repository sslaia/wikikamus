...
class BetawiHomePageBuilder implements HomePageBuilder {
  ...
  SliverAppBar buildWikiPageAppBar(BuildContext context, String title) {
    final String pageUrl = 'https://bew.m.wiktionary.org/wiki/$title';
  ...
  Widget buildHomePageBottomAppBar(BuildContext context) {
    final List<Widget> barChildren = [
      OpenDrawerButton(),
      BottomAppBarLabel(),
      SearchAndCreateIconButton(languageCode: 'bew'),
      RefreshHomeIconButton(),
      RandomIconButton(languageCode: 'bew'),
    ];
  ...
  Widget buildWikiPageBottomAppBar(BuildContext context, String title) {
    final List<Widget> barChildren = [
      ...
      HomeIconButton(),
      SearchAndCreateIconButton(languageCode: 'bew'),
      RefreshIconButton(languageCode: 'bew', title: title),
      RandomIconButton(languageCode: 'bew'),
    ];
    return BottomAppBar(child: Row(children: barChildren));
  }
  ...
  Widget buildDrawer(BuildContext context) {
    final List<Widget> drawerChildren = [
      ...
      DrawerCommunityToolsSection(
        languageCode: 'bew',
        mainPageTitle: 'Wikikamus:Balé-balé',
        recentChangesTitle: 'Istimèwa:Perubahan terbaru',
        randomPageTitle: 'Istimèwa:Halaman sembarang',
        specialPagesTitle: 'Istimèwa:Halaman istimewa',
        communityPortalTitle: 'Wikikamus:Balé-balé',
        helpTitle: 'Wikikamus:Balé-balé',
        sandboxTitle: 'Wikikamus:Balé-balé',
      ),
  ...
  Widget buildBody(BuildContext context, Future<String> futureContent,
    ...
    void navigateToNewPage(String title) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute<void>(
          builder: (context) => WikiPage(languageCode: 'bew', title: title),
        ),
      );
    }
    ...
    void navigateToCreatePage(String title) {
      final editUrl =
          'https://bew.m.wiktionary.org/w/index.php?title=$title&action=edit';
            ...
            child: Column(
              children: [
                if (pageType == PageType.home) ...[
                  ...
                  WiktionarySearch(languageCode: 'bew'),
                  const SizedBox(height: 28.0),
                ],
                ContentBody(
                  html: pageContent,
