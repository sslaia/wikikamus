...
class MadureseHomePageBuilder implements HomePageBuilder {
  @override
  ...
  SliverAppBar buildWikiPageAppBar(BuildContext context, String title) {
    final String pageUrl = 'https://mad.m.wiktionary.org/wiki/$title';
  ...
  Widget buildHomePageBottomAppBar(BuildContext context) {
    final List<Widget> barChildren = [
      OpenDrawerButton(),
      BottomAppBarLabel(),
      SearchAndCreateIconButton(languageCode: 'mad'),
      RefreshHomeIconButton(),
      RandomIconButton(languageCode: 'mad'),
    ];
  ...
  Widget buildWikiPageBottomAppBar(BuildContext context, String title) {
    final List<Widget> barChildren = [
      ...
      HomeIconButton(),
      SearchAndCreateIconButton(languageCode: 'mad'),
      RefreshIconButton(languageCode: 'mad', title: title),
      RandomIconButton(languageCode: 'mad'),
    ];
    return BottomAppBar(child: Row(children: barChildren));
  }
  ...
  Widget buildDrawer(BuildContext context) {
    final List<Widget> drawerChildren = [
      ...
      DrawerCommunityToolsSection(
        languageCode: 'mad',
        mainPageTitle: 'Wikikamus:Tanèyan',
        ...
        communityPortalTitle: 'Wikikamus:Bârung Kopi',
        helpTitle: 'Bhântowan:Èssè',
        sandboxTitle: 'Bhântowan:Èssè',
      ),
  ...
  Widget buildBody(BuildContext context, Future<String> futureContent,
    ...
    void navigateToNewPage(String title) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute<void>(
          builder: (context) => WikiPage(languageCode: 'mad', title: title),
        ),
      );
    }
    ...
    void navigateToCreatePage(String title) {
      final editUrl =
          'https://mad.m.wiktionary.org/w/index.php?title=$title&action=edit';
            ...
            child: Column(
              children: [
                if (pageType == PageType.home) ...[
                  ...
                  WiktionarySearch(languageCode: 'mad'),
                  const SizedBox(height: 28.0),
                ],
                ContentBody(
                  html: pageContent,
