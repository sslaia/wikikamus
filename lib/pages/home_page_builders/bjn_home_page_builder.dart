...
class BanjarHomePageBuilder implements HomePageBuilder {
  ...
  SliverAppBar buildWikiPageAppBar(BuildContext context, String title) {
    final String pageUrl = 'https://bjn.m.wiktionary.org/wiki/$title';
  ...
  Widget buildHomePageBottomAppBar(BuildContext context) {
    final List<Widget> barChildren = [
      OpenDrawerButton(),
      BottomAppBarLabel(),
      SearchAndCreateIconButton(languageCode: 'bjn'),
      RefreshHomeIconButton(),
      RandomIconButton(languageCode: 'bjn'),
    ];
  ...
  Widget buildWikiPageBottomAppBar(BuildContext context, String title) {
    final List<Widget> barChildren = [
      ...
      HomeIconButton(),
      SearchAndCreateIconButton(languageCode: 'bjn'),
      RefreshIconButton(languageCode: 'bjn', title: title),
      RandomIconButton(languageCode: 'bjn'),
    ];
    return BottomAppBar(child: Row(children: barChildren));
  }
  ...
  Widget buildDrawer(BuildContext context) {
    final List<Widget> drawerChildren = [
      ...
      DrawerCommunityToolsSection(
        languageCode: 'bjn',
        mainPageTitle: 'Laman Tatambaian',
        recentChangesTitle: 'Istimiwa:Paubahan pahanyarnya',
        randomPageTitle: 'Istimiwa:Tungkaran babarang',
        specialPagesTitle: 'Istimiwa:Tungkaran istimiwa',
        communityPortalTitle: 'Wikikamus:Warung Kupi',
        helpTitle: 'Wikikamus:Warung Kupi',
        sandboxTitle: 'Wikikamus:Warung Kupi',
      ),
  ...
  Widget buildBody(BuildContext context, Future<String> futureContent,
    ...
    void navigateToNewPage(String title) {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute<void>(
          builder: (context) => WikiPage(languageCode: 'bjn', title: title),
        ),
      );
    }
    ...
    void navigateToCreatePage(String title) {
      final editUrl =
          'https://bjn.m.wiktionary.org/w/index.php?title=$title&action=edit';
            ...
            child: Column(
              children: [
                if (pageType == PageType.home) ...[
                  ...
                  WiktionarySearch(languageCode: 'bjn'),
                  const SizedBox(height: 28.0),
                ],
                ContentBody(
                  html: pageContent,
